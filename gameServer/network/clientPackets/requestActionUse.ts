  ...
  init() {
    switch (this.getActionId()) {
      case 0:
        ...
        this._player.sendPacket(new ChangeWaitType(this._player.getObjectId(), this._player.getWaitType(), this._player.getLocation()));
        this._player.broadcast(new ChangeWaitType(this._player.getObjectId(), this._player.getWaitType(), this._player.getLocation()));
